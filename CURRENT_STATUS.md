...
`packages/services/DeviceAsWebcam/interface/jni/Encoder.cpp`. Its current I420
...
The complete current delta is also captured in
`lineageos/dipper/patches/0001-*.patch` through `0005-*.patch`, so the tested
state can be reproduced from clean LineageOS `lineage-22.2` sources.
